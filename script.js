...
function talkNPC(){
 if(area!=="map")return;
 for(let n of npcs){if(near(n.x,n.z,4)){knowledge+=5;npcText.innerText=n.name+": "+tips[Math.floor(Math.random()*tips.length)]+"\\n\\n+5 Knowledge";updateHUD();openPopup("npcPopup");return}}
}
function startBomb(){
